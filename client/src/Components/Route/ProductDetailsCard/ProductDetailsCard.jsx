...
const ProductDetailsCard = ({data, setOpen}) => {
  ...
  return (
    <div className="bg-[#fff]">
      {
        data ? (<div className="fixed w-full h-screen top-0 left-0 bg-[#0000030] z-40 flex items-center justify-center">
          ...
          <div className="w-full 800px:w-[50%]">
            ...
            <div className="flex">
              ...
              className="flex">
                ...
                alt=""
                className="w-[50px] h-[50px] roundedfull mr-2"
                />
                <div>
              ...
              <h1 className={`${styles.productTitle} text-[20px]`}>
                ...
                <div className="flex items-center mt-12 justify-between pr-3">
                  <div>
                    ...
                    <span className="bg-gray-200 tet-gray-800 font-medium px-4 py-[11px]">{count}</span>
